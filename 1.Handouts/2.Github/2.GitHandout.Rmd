...
But to ensure that things go smoothly, you will have access to a Mac desktop computer located in Lindley Hall.
You will then use your assigned computer by establishing a Remote Desktop connection.
You will use Git and GitHub on that computer to access and record changes to QB **worksheets** that contain in-class **exercises** and **assignments** that will eventually be submitted.
